...
call :CopyVst       "vst2/kmeter.pdf" "%vst2_32%"
...
call :CopyVst       "vst2/kmeter.pdf" "%vst2_32_categories%"
...
call :CopyVst       "vst2/kmeter.pdf" "%vst2_64%"
...
call :CopyVst       "vst2/kmeter.pdf" "%vst2_64_categories%"
