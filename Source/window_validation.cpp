    ...
    // create new window child of width "nWidth" and height "nHeight"
{
    ...
    LabelSampleRateValue->setBounds(nWidth - 192, nHeight - 244, 75, 20);
    ...
    ButtonDumpCSV->setBounds(nWidth - 192, nHeight - 109, 180, 20);
...
void WindowValidation::paint(Graphics& g)
{
    ...
    g.setOpacity(0.15f);
    g.drawRect(nWidth - 189, nHeight - 269, 182, 279);

    g.setColour(Colours::white);
    g.setOpacity(0.05f);
    g.fillRect(nWidth - 188, nHeight - 268, 180, 277);
}
