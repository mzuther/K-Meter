...
void AverageLevelFiltered::copyFromBuffer(frut::audio::RingBuffer &ringBuffer, const unsigned int pre_delay, const int sample_rate)
{
...
void AverageLevelFiltered::copyToBuffer(frut::audio::RingBuffer &destination, const unsigned int sourceStartSample, const unsigned int numSamples)
{
