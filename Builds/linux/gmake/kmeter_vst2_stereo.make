...
ifeq ($(config),debug_x32)
  ...
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname=kmeter_stereo_vst2_debug.so -Wl,--no-undefined ../../../libraries/fftw/bin/linux/i386/libfftw3f.a
...
ifeq ($(config),debug_x64)
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=kmeter_stereo_vst2_debug_x64.so -Wl,--no-undefined ../../../libraries/fftw/bin/linux/amd64/libfftw3f.a
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x32)
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -m32 -shared -Wl,-soname=kmeter_stereo_vst2.so -Wl,--no-undefined ../../../libraries/fftw/bin/linux/i386/libfftw3f.a
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x64)
  ...
  LIBS += -ldl -lfreetype -lpthread -lrt -lX11 -lXext
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -shared -Wl,-soname=kmeter_stereo_vst2_x64.so -Wl,--no-undefined ../../../libraries/fftw/bin/linux/amd64/libfftw3f.a
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
