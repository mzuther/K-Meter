...
ifeq ($(config),debug_x32)
  ...
  TARGET = $(TARGETDIR)/kmeter_debug
  OBJDIR = ../../../bin/.intermediate_linux/kmeter_standalone_stereo_debug/x32
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -D_DEBUG=1 -DDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=1 -DKMETER_STEREO=1 -DJucePlugin_Build_Standalone=1 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=0 -DJUCE_ALSA=1 -DJUCE_JACK=1 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
...
ifeq ($(config),debug_x64)
  ...
  TARGETDIR = ../../../bin/standalone
  TARGET = $(TARGETDIR)/kmeter_x64_debug
  OBJDIR = ../../../bin/.intermediate_linux/kmeter_standalone_stereo_debug/x64
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -D_DEBUG=1 -DDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=1 -DKMETER_STEREO=1 -DJucePlugin_Build_Standalone=1 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=0 -DJUCE_ALSA=1 -DJUCE_JACK=1 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  INCLUDES += -I../../../JuceLibraryCode -I../../../libraries -I../../../libraries/juce/modules -I../../../Source/frut -I/usr/include -I/usr/include/freetype2
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_x32)
  ...
  TARGETDIR = ../../../bin/standalone
  TARGET = $(TARGETDIR)/kmeter
  OBJDIR = ../../../bin/.intermediate_linux/kmeter_standalone_stereo_release/x32
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -DNDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=0 -DKMETER_STEREO=1 -DJucePlugin_Build_Standalone=1 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=0 -DJUCE_ALSA=1 -DJUCE_JACK=1 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  INCLUDES += -I../../../JuceLibraryCode -I../../../libraries -I../../../libraries/juce/modules -I../../../Source/frut -I/usr/include -I/usr/include/freetype2
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_x64)
  ...
  TARGETDIR = ../../../bin/standalone
  TARGET = $(TARGETDIR)/kmeter_x64
  OBJDIR = ../../../bin/.intermediate_linux/kmeter_standalone_stereo_release/x64
  DEFINES += -DJUCE_MODAL_LOOPS_PERMITTED=1 -DLINUX=1 -DNDEBUG=1 -DJUCE_CHECK_MEMORY_LEAKS=0 -DKMETER_STEREO=1 -DJucePlugin_Build_Standalone=1 -DJucePlugin_Build_LV2=0 -DJucePlugin_Build_VST=0 -DJucePlugin_Build_VST3=0 -DJUCE_ALSA=1 -DJUCE_JACK=1 -DJUCE_WASAPI=0 -DJUCE_DIRECTSOUND=0
  INCLUDES += -I../../../JuceLibraryCode -I../../../libraries -I../../../libraries/juce/modules -I../../../Source/frut -I/usr/include -I/usr/include/freetype2
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
