...
In any case, the average level meter is band-limited using a windowed-sinc
...
\emph{Thus, in ITU-R mode sine waves do \emph{not} read the same on
  average and peak level meters and pink noise (\SI{-20}{\dBFS}\,RMS,
  \SI{20}{\hertz} to \SI{20}{\kilo\hertz}) does \emph{not} read
  \SI{0}{\dB} on the K-20 average level meter.  So for calibration,
  please switch K-Meter to RMS mode.}
