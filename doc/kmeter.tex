...
\textbf{K-Meter} files from the downloaded archive.  For the plug-ins,
you'll then have to move the extracted files to your respective
plug-in folder (\path{~/.lv2}, \path{~/.vst},
...
Begin by starting \textbf{K-Meter}.  If in a Bash shell, try this:
