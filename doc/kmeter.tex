...
The VST plug-in's frequency response has been determined at a sample
rate of 192\,kHz using Christian-W. Budde's
...
\begin{center}
  \includegraphics[scale=0.65,clip]{include/images/fft_192khz-clean.png}
\end{center}
...
\begin{center}
  \includegraphics[scale=0.65,clip]{include/images/fft_192khz-rms.png}
\end{center}
...
\begin{center}
  \includegraphics[scale=0.65,clip]{include/images/fft_192khz-rms_zoomed.png}
\end{center}
