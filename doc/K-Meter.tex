...
\textbf{The folder} \path{kmeter} \textbf{is mandatory and must be
...
\num[retain-explicit-plus]{+1} means that both channels are \emph{in
  phase}, whereas a value of \num{-1} signals that the channels are
completely \emph{out of phase}.  Please note that the meter's scale is
not linear!
