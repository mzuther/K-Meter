    ...
    // create new window child of width "nWidth" and height "nHeight"
{
  ...
  TextEditorAbout->setFont(fontHeadline);
  TextEditorAbout->insertTextAtCaret(T("Trademarks\n"));
  ...
  // create and position an "about" button that appears as if it were
  // pressed down and which closes the window when clicked
  ...
  // create and position the image button which opens the license text
  // in a web browser
